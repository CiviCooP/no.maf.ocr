...
abstract class CRM_MAFOCR_Parser {
  ...
  function run($tableName,
               ...
               $timeout           = CRM_MAFOCR_Parser::DEFAULT_TIMEOUT,
               $contactSubType    = NULL,
    ...
    switch ($contactType) {
      case CRM_MAFOCR_Parser::CONTACT_INDIVIDUAL:
        $this->_contactType = 'Individual';
        break;

      case CRM_MAFOCR_Parser::CONTACT_HOUSEHOLD:
        $this->_contactType = 'Household';
        break;

      case CRM_MAFOCR_Parser::CONTACT_ORGANIZATION:
...
";
  ...
  function addField($name, $title, $type = CRM_Utils_Type::T_INT,
    ...
    $this->_fields[$name] = new CRM_MAFOCR_Field($name, $title, $type, $headerPattern, $dataPattern, $hasLocationType);
    if (empty($name)) {
      $this->_fields['doNotImport'] = new CRM_MAFOCR_Field($name, $title, $type, $headerPattern, $dataPattern, $hasLocationType);
    }
  }
  ...
  function set($store, $mode = self::MODE_SUMMARY) {
    ...
    switch ($this->_contactType) {
      case 'Individual':
        $store->set('contactType', CRM_MAFOCR_Parser::CONTACT_INDIVIDUAL);
        break;

      case 'Household':
        $store->set('contactType', CRM_MAFOCR_Parser::CONTACT_HOUSEHOLD);
        break;

      case 'Organization':
        $store->set('contactType', CRM_MAFOCR_Parser::CONTACT_ORGANIZATION);
    }
  ...
  function errorFileName($type) {
    ...
    switch ($type) {
      case CRM_MAFOCR_Parser::ERROR:
        $fileName .= '.errors';
        break;

      case CRM_MAFOCR_Parser::CONFLICT:
        $fileName .= '.conflicts';
        break;

      case CRM_MAFOCR_Parser::DUPLICATE:
        $fileName .= '.duplicates';
        break;

      case CRM_MAFOCR_Parser::NO_MATCH:
        $fileName .= '.mismatch';
        break;

      case CRM_MAFOCR_Parser::UNPARSED_ADDRESS_WARNING:
